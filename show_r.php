  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
    ...
    <body class="body">
        ...
        <div class="col-lg-4 m-auto">
            <br>
            <h1 class="text-grey text-center">Patients</h1>
            <br>
            <br>
        ...
        <?php
                ...
                $conn = OpenCon();
                $id=$_POST["region_id"];
                $ql = "select count(*) from information where Region_id=$id and Status='recovered'";
      ...
      <p class="p">&copy; Covid-19 Management System</p>
                ...
                <script type="text/javascript">
                    ...
                    jQuery(document).ready(function(){
                        ...
                        $.ajax({
                        	url: "get_coordinates_r.php?id=<?php echo $id ?>",
                            type: "GET",

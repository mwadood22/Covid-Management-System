...
<html>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
    ...
    <body class="body">
        ...
        <h1 class="text-white text-center">Quarantine ward form</h1>
        </div>
        <br>
...
if(isset($_POST['done']))
{
        ...
        $query = "INSERT INTO `quarantine_ward`(`Q_Ward_id`, `Capacity`, `Manager_id`, `Centre_id`) VALUES ('$ward_id','$capacity','$manager_id','$centre_id')";

...
<html>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
    ...
    <body class="body">
        ...
        <h1 class="text-white text-center">Staff form</h1>
        </div>
        <br>
        <label class="m-auto"> Staff id: </label>
        <input type="text" name="staff_id" class="form-control m-auto"> <br>
...
if(isset($_POST['done']))
{
        ...
        $query = "INSERT INTO `staff`(`Staff_id`, `Staff_Name`, `Job`, `Phone_no`, `Address`, `Centre_id`, `Manager_id`) VALUES ('$staff_id','$staff_name','$job','$phone_no','$address','$centre_id','$manager_id')";

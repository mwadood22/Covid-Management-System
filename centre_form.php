...
<html>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
    ...
    <body class="body">
        ...
        <h1 class="text-white text-center"> Centre form</h1>
        </div>
        <br>
...
if(isset($_POST['done']))
{
        ...
        $query = "INSERT INTO `centre`(`Centre_id`, `Centre_name`, `Sp_id`, `Region_id`) VALUES ('$centre_id','$centre_name','$sp_id','$region_id')";

...
<html>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
    ...
    <body class="body">
        ...
        <h1 class="text-white text-center">Super Manager form</h1>
        </div>
        <br>
        <label class="m-auto"> Super Manager ID: </label>
...
if(isset($_POST['done']))
{
        ...
        $query = "INSERT INTO `super_manager`(`sp_id`, `Name`, `Phone_no`, `Address`, `Password`) VALUES ('$sp_id','$sp_name','$phone_no','$address','$password')";

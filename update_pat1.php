...
if(isset($_POST['done']))
{
        ...
        $i_ward_id = $_POST["i_ward_id"];
        $manager_id = $_POST["manager_id"];
        $phone_no = $_POST["phone_no"];
        $region_id = $_POST["region_id"];

        $query = "UPDATE `patient` SET `P_id`='$id',`Name`='$name',`Status`='$status',`Address`='$address',`Latitude`='$latitude', `Longitude`='$longitude',`Q_Ward_id`=NULL,`I_Ward_id`='$i_ward_id',`Manager_id`='$manager_id',`Phone_no`='$phone_no',`Region_id`='$region_id' WHERE P_id=$id";

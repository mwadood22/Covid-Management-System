...
<html>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
    ...
    <body class="body">
        ...
        <h1 class="text-white text-center">Region form(Update)</h1>
        </div>
        <br>
...
if(isset($_POST['done']))
{
        ...
        $query = "UPDATE `region` SET `Region_id`='$region_id',`Region_Name`='$region_name',`Population`='$population',`Emergency_no`='$emergency_no',`sp_id`='$sp_id' WHERE Region_id=$region_id";

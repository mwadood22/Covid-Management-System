...
?>
      <!--  <div class="mySidenav">
  <a class="mySidenav" href="pat.php" id="contact">Cases </a>
  <br><br>
  <a class="mySidenav" href="recovered.php" id="contact">Recovered</a>
  <br><br> <a class="mySidenav" href="dead.php" id="contact">Deaths</a>
  <br><br>
</div> -->
        <br><br>
        <div class="container">

  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
    ...
    <body class="body">
        ...
        <div class="box">
            <br>
            <img src="5.jpg">
            <h1 class="details h1"><br><br>Precautions</h2>
              <br><br>
              <ul class="ul">
                <li>Wash Your Hands For 20sec</li>
                <li>Cover Nose & Mouth When Sneezing</li>
                <li>Use hand sanitizer if soap and water are not available.</li>
                <li>Avoid Crowded Places (Social Distancing)</li>
            ...
            <div class="footer">
                <div class="sub">
                    ...
                    <li><a class="active" href="recommendations.php">Recommendations</a></li>

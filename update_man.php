...
<html>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
    ...
    <body class="body">
        ...
        <h1 class="text-white text-center">Manager form(Update)</h1>
        </div>
        <br>
...
if(isset($_POST['done']))
{
        ...
        $query = "UPDATE `manager` SET `Manager_id`='$manager_id',`Manager_Name`='$manager_name',`Phone_no`='$phone_no',`Address`='$address',`Password`='$password',`sp_id`='$sp_id' WHERE Manager_id=$manager_id";

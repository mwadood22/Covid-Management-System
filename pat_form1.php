...
<html>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
    ...
    <body class="body">
        ...
        <div class="card-header bg-dark" class="px-2">
      ...
      <br>
        ...
        <button class="btn btn-success m-auto" name="done"> Submit </button>
        ...
        <div class="text-center">
            <button  onclick="location.href = 'patient_show.php';" type="button" class="float-right submit-button">Return to list</button>
            </div>
            <br><br>
        </div>
<br><br>
...
if(isset($_POST['done']))
{
        ...
        $query = "INSERT INTO `patient`(`P_id`, `Name`, `Status`, `Address`,`Latitude`, `Longitude`, `Q_Ward_id`, `I_Ward_id`,  `Manager_id`, `Phone_no`, `Region_id`) VALUES ('$p_id','$name','$status','$address','$latitude','$longitude','$q_ward_id', NULL ,'$manager_id','$phone_no','$region_id')";

    ...
    <body class="body">
        <div class="navbar">
            ...
            <div class="links">
                ...
                <a class="active" href="quarantine.php">Quarantine Wards</a>
        ...
        ?>
                ...
                <tr>
                        ...
                        <td><button class="btn-danger btn"> <a href="delete_qua.php?ward_id=<?php echo $res['Q_Ward_id']; ?>" class="text-white"> Delete </a> </button></td>
                        <td><button class="btn-primary btn"> <a href="update_qua.php?ward_id=<?php echo $res['Q_Ward_id']; ?>" class="text-white"> Update </a> </button></td>
                </tr>
                <?php
                }
                CloseCon($conn);
        ...
        <br><br>
            ...
            <div class="footer">
                <div class="sub">
                    ...
                    <li><a class="active" href="quarantine.php">Quarantine Wards</a></li>

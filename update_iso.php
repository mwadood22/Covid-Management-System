...
<html>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
    ...
    <body class="body">
        ...
        <h1 class="text-white text-center">Isolation ward form(Update)</h1>
        </div>
        <br>
...
if(isset($_POST['done']))
{
        ...
        $query = "UPDATE `isolation_ward` SET `I_Ward_id`=$ward_id,`Capacity`=$capacity,`Manager_id`=$manager_id,`Centre_id`=$centre_id WHERE I_Ward_id=$ward_id";

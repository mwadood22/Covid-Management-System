...
<html>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
    ...
    <body class="body">
        ...
        <div class="col-lg-12">
            <br>
            <h1 class="text-grey text-center">Super Managers data</h1>
            <br>
            <br>
            ...
            <table class="table table-striped table-hover table-bordered text-center m-auto">
                <tr>
                        ...
                        <th class="text-center">Super Manager ID</th>
        ...
        ?>
                ...
                <tr>
                        ...
                        <td><button class="btn-danger btn"> <a href="delete_sp.php?sp_id=<?php echo $res['sp_id']; ?>" class="text-white"> Delete </a> </button></td>
                        <td><button class="btn-primary btn"> <a href="update_sp.php?sp_id=<?php echo $res['sp_id']; ?>" class="text-white"> Update </a> </button></td>
                </tr>
                <?php
                }
                CloseCon($conn);
            ...
            <div class="text-center">
            <button onclick="location.href = 'sp_form.php';" type="submit" name="submit" class="float-right">Add new record</button>
            </div>
